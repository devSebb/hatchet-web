...
function Logo() {
  return (
    <Link
      ...
      href="/"
    >
      <BrandLogo alt="" className="h-8" priority variant="white" />
    </Link>
  );
}
...
export function Header() {
  ...
  return (
    <header
      className={cn(
        "sticky top-0 z-40 border-b pt-2 transition-[background-color,box-shadow,border-color] duration-(--dur-fast)",
        isElevated
