        ...
        {footerColumns.map((column, index) => (
          <div key={column.label}>
            ...
            {index === footerColumns.length - 1 ? (
              <Link
                className="border-border text-bg hover:border-brand/50 focus-visible:ring-ring/50 mt-3 inline-flex items-center gap-[6px] rounded-full border bg-white py-1.5 pr-3 pl-2 text-sm font-semibold transition-colors outline-none hover:bg-white/90 focus-visible:ring-3"
