      ...
      {siteConfig.socials.map((social) => (
        <li key={social.href}>
          <Link
            ...
            className="border-border text-muted hover:border-foreground/40 hover:text-foreground focus-visible:ring-ring/50 inline-flex size-9 items-center justify-center rounded-md border transition-colors outline-none focus-visible:ring-3"
            href={social.href}
            rel="noreferrer"
            target="_blank"
          >
