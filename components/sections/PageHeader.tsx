...
export function PageHeader({
  ...
  return (
    <section
      className={cn(
        // Padding lives on the section and the content box centers inside it
        // (same recipe as body sections) so hero copy shares their left edge.
        ...
        // the logo wall below.
        isGradient ? "pt-6 pb-32 lg:pt-8 lg:pb-44" : "py-16 lg:py-24",
        className,
      )}
    >
